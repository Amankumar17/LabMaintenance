...
tr:nth-child(even) {
  background-color: #dddddd;
    ...
    <div class="header" id="myHeader">
        ...
        <center>
            <br>
            <h3>Faculty's Complaint</h3>
        <div class="box">
        <form action="/filecomplaint2">
        <label>Faculty:</label><input type="text" class="in" name="fac_name" value='{{$fac_details[0]->First_name}} {{$fac_details[0]->Middle_name}} {{$fac_details[0]->Last_name}}'>
        <br><br><br>
        <label>     SDRN:     </label><input type="text" name='sdrn' class="in" value='{{$fac_details[0]->Sdrn}}'>
        <br><br><br>
        ...
        <script>
            ...
            var obj = <?php echo json_encode($complaint); ?>;
                ...
                // arr.sort(function(a,b){return a[1] - b[1]});
                // arr.reverse();
                var cont='<table><th>Serial No.</th><th>Lab no.</th><th>System no.</th><th>Complaint</th>';
                //console.log(arr.sort());
                //arr.sort(function(a, b){return a - b});
                //console.log(arr.(1.toString()).labno);
                for(i=0; i<arr.length; i++)
